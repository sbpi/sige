...
' Recupera usernames de escCliente
If w_unidade > "" Then
   sql = "SELECT a.sq_cliente, a.ds_username,b.sq_modelo from sbpi.Cliente a inner join sbpi.Cliente_Site b on (a.sq_cliente = b.sq_cliente) where upper(a.ds_username) = upper('" & w_unidade & "')"
Else
