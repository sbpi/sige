...
Sub showMenu
   ...
   ShowHTML "<HTML>"
   ShowHTML "<HEAD>"
   ShowHTML "   <link href=""/sige_ora/css/particular.css"" media=""screen"" rel=""stylesheet"" type=""text/css"" />"
   ShowHTML "<TITLE>" & "Controle Central" & "</TITLE>"
   ShowHTML "<style>"
...
REM -------------------------------------------------------------------------
Sub GetDocumento
  Dim w_chave, w_ds_titulo, w_ativo, w_ds_arquivo, w_ln_arquivo
  ...
  ElseIf w_ea = "L" Then
     ...
     Else
        SQL = "select * from sbpi.Cliente_Arquivo where " & replace(CL,"sq_cliente","sq_cliente") & " order by ativo, nr_ordem"
     End If
     ConectaBD SQL
  ...
  ElseIf Instr("IAEV",O) > 0 Then
    ...
    MontaRadioSN "<b>Exibir no site?</b>", w_ativo, "w_ativo"
    ShowHTML "        </table>"
    ShowHTML "      <tr>"
...
Sub GetEspecialidadeCliente
  ...
  If w_ea = "L" Then
     SQL = "select a.sq_especialidade, a.ds_especialidade, b.sq_especialidade as sq_codigo_cli " & VbCrLf & _
           "  from sbpi.Especialidade a " & VbCrLf & _
           "       left outer join sbpi.Especialidade_Cliente b on (a.sq_especialidade = b.sq_especialidade and b." & CL & ") " & VbCrLf & _
  ...
  ShowHTML "      <tr><td align=""center"" height=""1"" bgcolor=""#000000""></td></tr>"
  ShowHTML "      <tr><td><font size=1>Selecione áreas de atuação oferecidas pela rede de ensino.</font></td></tr>"
  ShowHTML "      <tr><td align=""center"" height=""1"" bgcolor=""#000000""></td></tr>"
  While Not RS.EOF
...
Sub GetDadosAdicionais
  ...
  If w_ea = "A" Then
     SQL = "select * from sbpi.Cliente_Dados where " & CL
     ConectaBD SQL
...
Sub Administrativo
  ...
  If w_ea = "A" Then
     SQL = "select * from sbpi.Cliente where " & CL
     ConectaBD SQL
     w_sq_cliente       = RS("sq_cliente")
...
Sub GetCliente
  ...
  ShowHTML "      <tr><td align=""center"" height=""1"" bgcolor=""#000000""></td></tr>"
  ShowHTML "      <tr><td><font size=1>Esta tela permite alterar a senha de acesso à tela de atualização dos dados da rede de ensino. Assim que a nova senha for gravada, ela já deverá ser utilizada para acessar telas desta aplicação.</font></td></tr>"
  ShowHTML "      <tr><td align=""center"" height=""1"" bgcolor=""#000000""></td></tr>"
...
Sub GetSite
  ...
  If w_ea = "A" Then
     SQL = "select * from sbpi.Cliente_Site where " & CL
     ConectaBD SQL
     w_sq_cliente          = RS("sq_cliente")
...
Sub GetNoticiaCliente
  Dim w_chave, w_ds_titulo, w_ativo, w_ds_noticia
  ...
  ElseIf w_ea = "L" Then
     ' Recupera todos os registros para a listagem
     If Session("username") = "IMPRENSA" or Session("username") = "SBPI" Then
        SQL = "select * from sbpi.Noticia_Cliente where sq_cliente = 0 order by dt_noticia desc"
      Else
        SQL = "select * from sbpi.Noticia_Cliente where " & replace(CL,"sq_cliente","sq_cliente") & " order by dt_noticia desc"
      End If
     ConectaBD SQL
  ElseIf InStr("AEV",w_ea) > 0 and w_Troca = "" Then
     ' Recupera os dados do endereço informado
     SQL = "select * from sbpi.Noticia_Cliente where sq_noticia = " & w_chave
     ConectaBD SQL
...
Sub GetSistema
  ...
  ElseIf w_ea = "L" Then
     ' Recupera todos os registros para a listagem
     SQL = "select * from sbpi.Sistema order by no_sistema"
     ConectaBD SQL
  ElseIf InStr("AE",w_ea) > 0 and w_Troca = "" Then
     ' Recupera os dados do endereço informado
     SQL = "select * from sbpi.Sistema where sq_sistema = " & w_chave
     ConectaBD SQL
...
Sub GetComponente
  ...
  ElseIf w_ea = "L" Then
     ...
     SQL = "select a.*, b.sg_sistema " & VbCrLf & _
           "  from sbpi.Componente a " & VbCrLf & _
           "       inner join sbpi.Sistema b on (a.sq_sistema = b.sq_sistema) " & VbCrLf & _
           "order by a.no_fisico "
     ConectaBD SQL
  ElseIf InStr("AE",w_ea) > 0 and w_Troca = "" Then
     ' Recupera os dados do endereço informado
     SQL = "select * from sbpi.Componente where sq_componente = " & w_chave
     ConectaBD SQL
  ...
  ElseIf w_ea = "V" Then
     ...
     ' Recupera versões do componente informado
     SQL = "select a.*, c.sg_sistema, c.no_sistema, b.no_fisico, b.ds_componente, b.ativo cm_ativo" & VbCrLf & _
           "  from sbpi.Componente_Versao     a " & VbCrLf & _
           "       inner join sbpi.Componente b on (a.sq_componente = b.sq_componente) " & VbCrLf & _
           "       inner join sbpi.Sistema    c on (b.sq_sistema    = c.sq_sistema) " & VbCrLf & _
  ...
  ElseIf Instr("IAE",w_ea) > 0 Then
    ...
    SQL = "select sq_sistema, sg_sistema from sbpi.Sistema order by sg_sistema" & VbCrLf
    ConectaBD SQL
    While Not RS.EOF
...
Sub GetVersao
  ...
  ElseIf w_ea = "L" Then
     ...
     SQL = "select a.*, c.sg_sistema, b.no_fisico " & VbCrLf & _
           "  from sbpi.Componente_Versao     a " & VbCrLf & _
           "       inner join sbpi.Componente b on (a.sq_componente = b.sq_componente and " & VbCrLf & _
           "                                      b.ativo         = 'S' " & VbCrLf & _
           "                                     ) " & VbCrLf & _
           "       inner join sbpi.Sistema    c on (b.sq_sistema    = c.sq_sistema and " & VbCrLf & _
           "                                      c.ativo         = 'S' " & VbCrLf & _
           "                                     ) " & VbCrLf & _
           "       inner join (select sq_componente, max(replace(cd_versao,'.','')) versao " & VbCrLf & _
           "                     from sbpi.Componente_Versao " & VbCrLf & _
  ...
  ElseIf InStr("AEV",w_ea) > 0 and w_Troca = "" Then
     ' Recupera os dados do endereço informado
     SQL = "select * from sbpi.Componente_Versao where sq_componente_versao = " & w_chave
     ConectaBD SQL
  ...
  ElseIf Instr("IAEV",O) > 0 Then
    ...
    ShowHTML "          <OPTION VALUE="""">---"
    SQL = "select a.sq_componente, b.sg_sistema||' - '||a.no_fisico nm_componente from sbpi.Componente a inner join sbpi.Sistema b on (a.sq_sistema = b.sq_sistema) order by b.sg_sistema, a.no_fisico " & VbCrLf
    ConectaBD SQL
    While Not RS.EOF
  ...
  ElseIf w_ea = "L" or w_ea = "G" Then
     If Session("username") = "IMPRENSA" or Session("username") = "SBPI" Then
        SQL = "select sq_newsletter, nome, email, tipo, envia_mail, data_inclusao, data_alteracao, " & VbCrLf & _
              ...
              "       case envia_mail when 'S' then 'S' else 'Não' end nm_envia " & VbCrLf & _
              "  from sbpi.Newsletter " & VbCrLf & _
...
Sub GetCalendarioBase
  ...
  ElseIf Instr("IAEV",O) > 0 Then
    ...
    SQL = "SELECT * from sbpi.Tipo_Data a WHERE a.abrangencia <> 'U' ORDER BY a.nome" & VbCrLf
    ConectaBD SQL
...
Sub GetCalendario
  ...
  ElseIf w_ea = "L" Then
     ' Recupera todos os registros para a listagem
     SQL = "select a.*, b.nome from sbpi.Calendario_Cliente a left join sbpi.Tipo_Data b on (a.sq_tipo_data = b.sq_tipo_data) where " & replace(CL,"sq_cliente","sq_cliente") & " order by sbpi.year(dt_ocorrencia) desc, dt_ocorrencia"
     ConectaBD SQL
  ElseIf InStr("AEV",w_ea) > 0 and w_Troca = "" Then
     ' Recupera os dados do endereço informado
     SQL = "select * from sbpi.Calendario_Cliente where sq_ocorrencia = " & w_chave
     ConectaBD SQL
     w_dt_ocorrencia = FormataDataEdicao(RS("dt_ocorrencia"))
     w_ds_ocorrencia = RS("ds_ocorrencia")
     w_tipo          = RS("sq_tipo_data")
...
Sub GetMensagem
  ...
  ElseIf w_ea = "L" Then
     ...
     SQL = "select a.*, b.no_aluno, b.nr_matricula, c.ds_cliente " & VbCrLf & _
           "  from sbpi.Mensagem_Aluno     a " & VbCrLf & _
           "       inner join sbpi.Aluno   b on (a.sq_aluno        = b.sq_aluno) " & VbCrLf & _
           "       inner join sbpi.Cliente c on (b.sq_cliente = c.sq_cliente) " & VbCrLf & _
...
Sub GetEspecialidade
  ...
  SQL = "Select * from sbpi.Especialidade order by nr_ordem, ds_especialidade"
  ConectaBD SQL
  If Not RS.EOF Then
  ...
  ElseIf InStr("AEV",w_ea) > 0 and w_Troca = "" Then
     ' Recupera os dados do endereço informado
     SQL = "select * from sbpi.Especialidade where sq_especialidade = " & w_chave
     ConectaBD SQL
...
Sub GetTipoCliente
  ...
  ElseIf w_ea = "L" Then
     ...
     SQL = "select sq_tipo_cliente, ds_tipo_cliente, ds_registro, tipo, " & VbCrLf & _
           ...
           "       end nm_tipo                        " & VbCrLf & _
           "  from sbpi.Tipo_Cliente                    " & VbCrLf
     ConectaBD SQL
  ElseIf InStr("AEV",w_ea) > 0 and w_Troca = "" Then
     ' Recupera os dados do endereço informado
     SQL = "select * from sbpi.Tipo_cliente where sq_tipo_Cliente = " & w_chave
     ConectaBD SQL
     w_tipo         = RS("tipo")
...
Sub LogOn
  ...
  ShowHTML "              . <a class=""SS"" href=""sedf/Orientacoes_Acesso.pdf"" target=""_blank"" title=""Abre arquivo que descreve novas características e funcionalidades do SIGE-WEB."">Apresentação da nova versão do SIGE-WEB (PDF - 130KB - 4 páginas)</a><BR>"
...
Sub Valida
  ...
  ConectaBD SQL
  If cInt(RS("existe")) = 0 Then
     w_Erro = 1
  Else
     SQL = "select count(*) existe " & VbCrLf & _
           "  from sbpi.Cliente           a " & VbCrLf & _
           "       join sbpi.Tipo_Cliente b on (a.sq_tipo_cliente = b.sq_tipo_cliente and " & VbCrLf & _
           "                                  b.tipo            = 1 " & VbCrLf & _
           "                                 ) " & VbCrLf & _
  ...
  Else
     ...
     SQL = "select sq_cliente, ds_username from sbpi.Cliente where upper(ds_username) = upper('" & w_uid & "') and upper(ds_senha_acesso) = upper('" & w_pwd & "')"
     ConectaBD SQL
     ...
     If Session("username") <> "SBPI" Then
        ...
        SQL = "insert into sbpi.Cliente_Log (sq_cliente_log, sq_cliente, data, ip_origem, tipo, abrangencia, sql) " & VbCrLf & _
              "( select sbpi.sq_cliente_log.nextval, " & VbCrLf & _
              "         " & w_cliente & ", " & VbCrLf & _
              "         sysdate, " & VbCrLf & _
...
Sub ShowAdmin
  ...
  SQL = "select a.ds_cliente, b.* from sbpi.Cliente a inner join sbpi.Cliente_Admin b on (a.sq_cliente = b.sq_cliente) where a." & CL
  ConectaBD SQL
  If RS.EOF Then
  ...
  ShowHTML "      <tr><td align=""center"" height=""1"" bgcolor=""#000000""></td></tr>"
  SQL = "select a.nome, b.sq_equipamento, b.nome nm_equipamento, coalesce(c.quantidade, 0) quantidade " & VbCrLf & _
        "  from sbpi.Tipo_Equipamento               a " & VbCrLf & _
        "       inner join sbpi.Equipamento         b on (a.sq_tipo_equipamento = b.sq_tipo_equipamento) " & VbCrLf & _
        "       inner join sbpi.Cliente_Equipamento c on (b.sq_equipamento      = c.sq_equipamento and " & VbCrLf & _
...
Public Sub GetVerifArquivo
  ...
  If Request("pesquisa") > "" Then
     If Request("E") = "S" Then
        sql = "SELECT DISTINCT 'ARQUIVO' tipo, d.ds_username, d.sq_cliente, d.ds_cliente, d.ds_apelido, d.ln_internet, f.ds_diretorio," & VbCrLf & _
              "       h.sq_arquivo chave, h.ds_titulo, h.nr_ordem, h.ln_arquivo " & VbCrLf & _
              "  from sbpi.Cliente                                 d " & VbCrLf & _ 
              "       INNER      join sbpi.Cliente                 b ON (b.sq_cliente       = d.sq_cliente_pai) " & VbCrLf & _
              "       INNER      join sbpi.Cliente_Site            f ON (d.sq_cliente       = f.sq_cliente) " & VbCrLf & _
              "       INNER      join sbpi.Tipo_Cliente            g ON (d.sq_tipo_cliente  = g.sq_tipo_cliente) " & VbCrLf & _
              "       INNER      join sbpi.Cliente_Arquivo         h ON (d.sq_cliente       = h.sq_cliente) " & VbCrLf & _
              " where 1 = 1 " & VbCrLf
        ...
        if sql1 > "" then
          sql = sql & _
                "    and (0 < (select count(*) from sbpi.Especialidade_Cliente where sq_cliente = d.sq_cliente and to_char(sq_especialidade) in (" + sql1 + ")) or " & VbCrLf & _
                "         0 < (select count(*) from sbpi.Turma_Modalidade  w INNER join sbpi.Turma x ON (w.serie = x.ds_serie) where x.sq_cliente = d.sq_cliente and w.curso in (" + sql1 + ")) " & VbCrLf & _
                "        ) " & VbCrLf 
        end if
        sql = sql & _
              "UNION SELECT DISTINCT 'FOTO' tipo, d.ds_username, d.sq_cliente, d.ds_cliente, d.ds_apelido, d.ln_internet, f.ds_diretorio," & VbCrLf & _
              "       h.sq_cliente_foto chave, h.ds_foto ds_titulo, h.nr_ordem, h.ln_foto ln_arquivo " & VbCrLf & _
              "  from sbpi.Cliente                                 d " & VbCrLf & _ 
              "       INNER      join sbpi.Cliente                 b ON (b.sq_cliente       = d.sq_cliente_pai) " & VbCrLf & _
              "       INNER      join sbpi.Cliente_Site            f ON (d.sq_cliente       = f.sq_cliente) " & VbCrLf & _
              "       INNER      join sbpi.Tipo_Cliente            g ON (d.sq_tipo_cliente  = g.sq_tipo_cliente) " & VbCrLf & _
              "       INNER      join sbpi.Cliente_Foto            h ON (d.sq_cliente       = h.sq_cliente) " & VbCrLf & _
              " where 1 = 1 " & VbCrLf
        If Mid(Session("username"),1,2) = "RE" Then
           SQL = SQL & "   and b.ds_username = '" & Session("USERNAME") & "' " & VbCrLf
        End If
           ...
           While Not RS.EOF
             ...
             For each File in Folder.files
                If File.name <> "default.asp" Then                        
                   sqlstr = "select coalesce(a.qtd,0) + coalesce(b.qtd,0) quantidade " & VbCrLf & _
                            "from (select count(*) qtd from sbpi.Cliente_Foto where sq_cliente = " & RS("SQ_CLIENTE") & " and ln_foto = '" & File.name & "') a, " & VbCrLf & _
                            "     (select count(*) qtd from sbpi.Cliente_Arquivo where sq_cliente = " & RS("SQ_CLIENTE") & " and ln_arquivo = '" & File.name & "') b " & VbCrLf
...
Public Sub Grava
  ...
  Else
     SQL = "select sq_funcionalidade from sbpi.Funcionalidade where tipo = 1 and codigo = '" & w_R & "'"
     ConectaBD SQL
  ...
  Select Case w_R
    Case conWhatCliente
       ...
       If Session("username") <> "SBPI" Then
          w_sql = SQL
          SQL = "insert into sbpi.Cliente_Log (sq_cliente_log, sq_cliente, data, ip_origem, tipo, abrangencia, sql, sq_funcionalidade) " & VbCrLf & _
                "( select sbpi.sq_cliente_log.nextval, " & VbCrLf & _
    ...
    Case conWhatDadosAdicionais
       dbms.BeginTrans()
       SQL = "update sbpi.Cliente_Dados set " & VbCrLf & _
    ...
    Case conWhatSite
       dbms.BeginTrans()
       SQL = "update sbpi.Cliente_Site set " & VbCrLf & _
    ...
    Case conWhatEspecialidadeCliente
       dbms.BeginTrans()
       ' Apaga especialidades existentes para a rede de ensino
       SQL = "delete sbpi.Especialidade_Cliente where " & CL & VbCrLf
       w_sql = SQL & VbCrLf
       ExecutaSQL(SQL)
           
       ' Em seguida, cria apenas especialidades indicadas pelo cliente
       For w_cont = 1 To Request.Form("w_chave").Count
          SQL = "insert into sbpi.Especialidade_Cliente (sq_cliente, sq_especialidade) " & VbCrLf & _
                "values (" & VbCrLf & _
                "   " & Request("w_sq_cliente") & ", " & VbCrLf & _
    ...
    Case conWhatDocumento
       If Session("username") = "IMPRENSA" or Session("username") = "SBPI" Then
          SQL = "select a.ds_username from sbpi.Cliente a where a.sq_cliente = 0"
          ConectaBD SQL
          w_diretorio = replace(conFilePhysical & "\" & RS("ds_username") &  "\" & RS("ds_username") & "\","\\","\")
          DesconectaBD
       Elseif Mid(Session("username"),1,2) = "RE" Then
          SQL = "select a.ds_username from sbpi.Cliente a where a." & CL
          ConectaBD SQL
       ...
       If w_ea = "I" Then
          ...
          SQL = "select sbpi.sq_arquivo.nextval chave from sbpi.Cliente_Arquivo" & VbCrLf
          ConectaBD SQL
          w_chave = RS("chave")
          DesconectaBD
          
          ' Insere o arquivo
          SQL = " insert into sbpi.Cliente_Arquivo " & VbCrLf & _
                "    (sq_arquivo, sq_cliente, dt_arquivo, ds_arquivo, ln_arquivo, " & VbCrLf & _
                "     ativo,   in_destinatario, nr_ordem,   ds_titulo) " & VbCrLf & _
          ...
          SQL = SQL & _
                "     to_date('" & FormataDataEdicao(FormatDateTime(Date(),2)) & "','dd/mm/yyyy'), " & VbCrLf & _
                "     '" & ul.Form("w_ds_arquivo") & "', " & VbCrLf & _
                "     '" & w_imagem & "', " & VbCrLf & _
                "     '" & ul.Form("w_ativo") & "', " & VbCrLf & _
          ...
          w_sql = SQL
          SQL = "insert into sbpi.Cliente_Log (sq_cliente_log, sq_cliente, data, ip_origem, tipo, abrangencia, sql, sq_funcionalidade) " & VbCrLf & _
                " ( select sbpi.sq_cliente_log.nextval, " & VbCrLf
          If Session("username") = "IMPRENSA" OR Session("username") = "SBPI" Then SQL = SQL & "0," & VbCrLf Else SQL = SQL & "     " & ul.Form("w_sq_cliente") & ", " & VbCrLf End If
          SQL = SQL & _
                "         sysdate, " & VbCrLf & _
                "         '" & Request.ServerVariables("REMOTE_HOST") & "', " & VbCrLf & _
       ...
       ElseIf w_ea = "A" Then
          ...
          SQL = "select ln_arquivo arquivo from sbpi.Cliente_Arquivo where sq_arquivo = " & ul.Form("w_chave")
          ConectaBD SQL
          w_arquivo = RS("arquivo")
          DesconectaBD

          SQL = " update sbpi.Cliente_Arquivo set " & VbCrLf & _
                "     ds_titulo       = '" & ul.Form("w_ds_titulo") & "', " & VbCrLf & _
                "     dt_arquivo      = to_date('" & FormataDataEdicao(FormatDateTime(Date(),2)) & "','dd/mm/yyyy'), " & VbCrLf & _
                "     ds_arquivo      = '" & ul.Form("w_ds_arquivo") & "', " & VbCrLf & _
                "     ativo        = '" & ul.Form("w_ativo") & "', " & VbCrLf & _
       ...
       ElseIf w_ea = "E" Then
          ' Remove o arquivo físico
          SQL = "select ln_arquivo from sbpi.Cliente_Arquivo where sq_arquivo = " & Request("w_chave")
          ConectaBD SQL
          DeleteAFile w_diretorio & RS("ln_arquivo")
          DesconectaBD
          

          SQL = " delete sbpi.Cliente_Arquivo where sq_arquivo = " & Request("w_chave") & VbCrLf
          ExecutaSQL(SQL)
    ...
    Case "BASE"
       ...
       If w_ea = "I" Then
          ' Recupera o valor da próxima chave primária
          SQL = "select sbpi.sq_ocorrencia.nextval chave from sbpi.Calendario_Base" & VbCrLf
          ConectaBD SQL
          w_chave = RS("chave")
          DesconectaBD
                    
          ' Insere o arquivo
          SQL = " insert into sbpi.Calendario_Base " & VbCrLf & _
                "    (sq_ocorrencia, in_abrangencia, dt_ocorrencia, ds_ocorrencia, sq_tipo_data) " & VbCrLf & _
                " values ( " & w_chave & ", 'T', " & VbCrLf & _
                "     to_date('" & FormataDataEdicao(FormatDateTime(Request("w_dt_ocorrencia"),2)) & "','dd/mm/yyyy'), " & VbCrLf & _
          ...
          End If
       ElseIf w_ea = "A" Then
          SQL = " update sbpi.Calendario_Base set " & VbCrLf & _
                "     dt_ocorrencia  = to_date('" & FormataDataEdicao(FormatDateTime(Request("w_dt_ocorrencia"),2)) & "','dd/mm/yyyy'), " & VbCrLf & _
          ...
          End If
       ElseIf w_ea = "E" Then
          SQL = " delete sbpi.Calendario_Base where sq_ocorrencia = " & Request("w_chave") & VbCrLf
          ExecutaSQL(SQL)
    ...
    Case conWhatAdmin
       ...
       Else
          ...
          If Request("w_arquivo") = "Escola" Then
             ...
             f1.WriteLine "2 - 5 primeiras colunas são duplicadas para cada um dos equipamentos da unidade de ensino;"
             ...
             SQL = "select f.sq_siscol cd_escola, e.ds_cliente nm_escola, " & VbCrLf & _
                   ...
                   "  from sbpi.Cliente                                   e " & VbCrLf & _
                   "       inner            join sbpi.Cliente_Site        f on (e.sq_cliente          = f.sq_cliente) " & VbCrLf & _
                   "       inner            join sbpi.Cliente_Admin       d on (e.sq_cliente          = d.sq_cliente) " & VbCrLf & _
                   "         left outer     join sbpi.Cliente_Equipamento c on (d.sq_cliente          = c.sq_cliente) " & VbCrLf & _
                   "           left outer   join sbpi.Equipamento         b on (c.sq_equipamento      = b.sq_equipamento) " & VbCrLf & _
                   "             left outer join sbpi.Tipo_Equipamento    a on (b.sq_tipo_equipamento = a.sq_tipo_equipamento) " & VbCrLf & _
    ...
    Case conWhatCalendario
       ...
       If w_ea = "I" Then
          ' Recupera o valor da próxima chave primária
          SQL = "select sbpi.sq_ocorrencia.nextval chave from sbpi.Calendario_Cliente" & VbCrLf
          ConectaBD SQL
          w_chave = RS("chave")
          DesconectaBD
          
          ' Insere o arquivo
          SQL = " insert into sbpi.Calendario_Cliente " & VbCrLf & _
                "    (sq_ocorrencia, sq_cliente, dt_ocorrencia, ds_ocorrencia, sq_tipo_data) " & VbCrLf & _
          ...
          End If
       ElseIf w_ea = "A" Then
          SQL = " update sbpi.Calendario_Cliente set " & VbCrLf & _
                "     dt_ocorrencia  = to_date('" & FormataDataEdicao(FormatDateTime(Request("w_dt_ocorrencia"),2)) & "','dd/mm/yyyy'), " & VbCrLf & _
                "     ds_ocorrencia  = '" & Request("w_ds_ocorrencia") & "', " & VbCrLf & _
                "     sq_tipo_data  = '" & Request("w_tipo") & "' " & VbCrLf & _
                "where sq_ocorrencia = " & Request("w_chave") & VbCrLf
          ...
          End If
       ElseIf w_ea = "E" Then
          SQL = " delete sbpi.Calendario_Cliente where sq_ocorrencia = " & Request("w_chave") & VbCrLf
          ExecutaSQL(SQL)
    ...
    Case "NEWSLETTER"
       ...
       If w_ea = "I" Then
          ' Insere o registro
          SQL = "insert into sbpi.Newsletter (sq_cliente, nome, email, tipo, envia_mail, data_inclusao, data_alteracao) " & VbCrLf & _
                "  values ( 0," & VbCrLf & _
                ...
                "         )" & VbCrLf
       ElseIf w_ea = "A" Then
          SQL = "update sbpi.Newsletter set " & VbCrLf & _
                ...
                "   data_alteracao = sysdate " & VbCrLf & _
                "where sq_newsletter = " & Request("w_chave") & VbCrLf
       ElseIf w_ea = "E" Then
          SQL = " delete sbpi.Newsletter where sq_newsletter = " & Request("w_chave") & VbCrLf
       End If
       ExecutaSQL(SQL)
       dbms.CommitTrans()
    ...
    Case "TIPOCLIENTE"
       ...
       If w_ea = "I" Then
          SQL = "select sbpi.sq_tipo_cliente.nextval chave from sbpi.Tipo_Cliente" & VbCrLf
          ConectaBD SQL
          w_chave = RS("chave")
          DesconectaBD
          ' Insere o registro
          SQL = "insert into sbpi.Tipo_Cliente (sq_tipo_cliente, ds_tipo_cliente, ds_registro, tipo) " & VbCrLf & _
                " values ( " & w_chave           & " ," & VbCrLf & _
                ...
                "         )" & VbCrLf
       ElseIf w_ea = "A" Then
          SQL = "update sbpi.Tipo_Cliente set " & VbCrLf & _
                "   ds_tipo_Cliente    = '" & (Request("w_nome")) & "'," & VbCrLf & _
                "   ds_registro        =     null                     ," & VbCrLf & _
                "   tipo               = " & Request("w_tipo")           & VbCrLf & _
                "where sq_tipo_cliente = " & Request("w_chave")          & VbCrLf
       ElseIf w_ea = "E" Then
          SQL = " delete sbpi.Tipo_Cliente where sq_tipo_cliente = " & Request("w_chave") & VbCrLf
       End If
       ExecutaSQL(SQL)
       dbms.CommitTrans()
    ...
    Case conWhatNotCliente
       ...
       If w_ea = "I" Then
          ' Recupera o valor da próxima chave primária
          SQL = "select sbpi.sq_noticia.nextval chave from sbpi.Noticia_Cliente" & VbCrLf
          ConectaBD SQL
          w_chave = RS("chave")
          DesconectaBD
          
          ' Insere o arquivo
          SQL = " insert into sbpi.Noticia_Cliente " & VbCrLf & _
                "    (sq_noticia, sq_cliente, dt_noticia, ds_titulo, ds_noticia, ativo) " & VbCrLf & _
                " values ( " & w_chave & ", " & VbCrLf
          If Session("username") = "IMPRENSA" or Session("username") = "SBPI" Then SQL = SQL & "0," & VbCrLf Else SQL = SQL & "     " & Request("w_sq_cliente") & ", " & VbCrLf End If
          SQL = SQL & _
                "     to_date('" & FormataDataEdicao(FormatDateTime(Request("w_dt_noticia"),2)) & "','dd/mm/yyyy'), " & VbCrLf & _
          ...
          End If
       ElseIf w_ea = "A" Then
          SQL = " update sbpi.Noticia_Cliente set " & VbCrLf & _
                "     dt_noticia  = to_date('" & FormataDataEdicao(FormatDateTime(Request("w_dt_noticia"),2)) & "','dd/mm/yyyy'), " & VbCrLf & _
          ...
          End If
       ElseIf w_ea = "E" Then
          SQL = " delete sbpi.Noticia_Cliente where sq_noticia = " & Request("w_chave") & VbCrLf
          ExecutaSQL(SQL)
    ...
    Case conWhatSGE
       ...
       If w_ea = "I" Then
          ' Insere o arquivo
          SQL = " insert into sbpi.Sistema " & VbCrLf & _
          ...
          ExecutaSQL(SQL)
       ElseIf w_ea = "A" Then
          SQL = " update sbpi.Sistema set " & VbCrLf & _
          ...
          ExecutaSQL(SQL)
       ElseIf w_ea = "E" Then
          SQL = " delete sbpi.Sistema where sq_sistema = " & Request("w_chave") & VbCrLf
          ExecutaSQL(SQL)
       End If
       dbms.CommitTrans()
    ...
    Case "COMPONENTE"
       ...
       If w_ea = "I" Then
          ' Insere o arquivo
          SQL = " insert into sbpi.Componente " & VbCrLf & _
          ...
          ExecutaSQL(SQL)
       ElseIf w_ea = "A" Then
          SQL = " update sbpi.Componente set " & VbCrLf & _
          ...
          ExecutaSQL(SQL)
       ElseIf w_ea = "E" Then
          SQL = " delete sbpi.Componente where sq_componente = " & Request("w_chave") & VbCrLf
          ExecutaSQL(SQL)
       End If
       dbms.CommitTrans()
    ...
    Case "VERSAO"
       ...
       If w_ea = "I" Then
          ...
          SQL = "set nocount on " & VbCrLf & _
                "insert into sbpi.Componente_Versao " & VbCrLf & _
                ...
                "     to_date('" & FormataDataEdicao(FormatDateTime(ul.Form("w_dt_versao"),2)) & "','dd/mm/yyyy'), " & VbCrLf & _
                "     '" & ul.Form("w_ds_caminho") & "', " & VbCrLf & _
                "     '" & w_arquivo & "' " & VbCrLf & _
                ") " & VbCrLf & _
                "select @@identity chave " & VbCrLf & _
       ...
       ElseIf w_ea = "A" Then
          ...
          SQL = "select no_arquivo arquivo from sbpi.Componente_Versao where sq_componente_versao = " & ul.Form("w_chave")
          ConectaBD SQL
          w_arquivo = ul.Form("w_chave") & Mid(RS("arquivo"), Instr(RS("arquivo"),"."), 50)
          DesconectaBD

          SQL = " update sbpi.Componente_Versao set " & VbCrLf & _
                ...
                "     dt_versao     = to_date('" & FormataDataEdicao(FormatDateTime(ul.Form("w_dt_versao"),2)) & "','dd/mm/yyyy'), " & VbCrLf & _
       ...
       ElseIf w_ea = "E" Then
          ' Remove o arquivo físico
          SQL = "select no_arquivo arquivo from sbpi.Componente_Versao where sq_componente_versao = " & Request("w_chave")
          ConectaBD SQL
          ...
          ' Remove o registro
          SQL = " delete sbpi.Componente_Versao where sq_componente_versao = " & Request("w_chave") & VbCrLf
          ExecutaSQL(SQL)
          dbms.CommitTrans()
       ...
       ElseIf w_ea = "G" Then
          ...
          w_atual = ""
          ScriptOpen "JavaScript"
          ' Recupera versões mais atuais para a geração do arquivo
             ...
             if len(w_linha) > 0 then
                 ...
                 ElseIf w_tipo = "REDE" Then
                    ...
                    If cInt(RS("Registros")) = 0 Then
                       ...
                       SQL = "INSERT into sbpi.Cliente (sq_cliente,ativo,sq_tipo_cliente, ds_cliente, no_municipio, sg_uf, ds_username, ds_senha_acesso, localizacao, publica, sq_regiao_adm) " & VbCrLf & _
                             "(SELECT " & sq_cliente & ", 'S', a.sq_tipo_cliente, " & idInstituicao & ", " & VbCrLf & _
                             "        substr(b.no_regiao, charIndex(' ',b.no_regiao)+1,500), 'DF', " & VbCrLf & _
                             "        " & login & ", " & senha & ", " & idLocalizacao & ", 'N', " & idRegiao & VbCrLf & _
                             "   from sbpi.Tipo_Cliente a, " & VbCrLf & _
                    ...
                    Else
                       ...
                       SQL = "update sbpi.Cliente SET " & VbCrLf & _
                             ...
                             "       no_municipio    = (select substr(no_regiao, charIndex(' ',no_regiao)+1,500) from sbpi.Regiao_Administrativa where sq_regiao_adm = " & idRegiao & "), " & VbCrLf & _
                             "       localizacao     = " & idLocalizacao & ", " & VbCrLf & _
                             "       sq_regiao_adm   = " & idRegiao & VbCrLf & _
                             "  WHERE sq_cliente = " & sq_cliente
                       ExecutaSQL(SQL)

                       SQL = "update sbpi.Cliente_Particular SET " & VbCrLf & _
                    ...
                    SQL = "select a.sq_cliente, c.sq_especialidade, c.ds_especialidade " & VbCrLf & _
                          "  from sbpi.Cliente                       a " & VbCrLf & _
                          "       inner join sbpi.Cliente_Particular b on (a.sq_cliente = b.sq_cliente), " & VbCrLf & _
                ...
                ElseIf w_tipo = "ARQUIVOS" Then
                    ...
                    SQL =  "INSERT into sbpi.CLIENTE_ARQUIVO (SQ_ARQUIVO,sq_cliente,DT_ARQUIVO,DS_TITULO,DS_ARQUIVO,LN_ARQUIVO,ativo,IN_DESTINATARIO,NR_ORDEM) " & VbCrLf & _
                           ...
                           "        'A'," & VbCrLf & _
                           "        1" & VbCrLf & _
                           "   from sbpi.Cliente_Particular a " & VbCrLf & _
                ...
                ElseIf w_tipo = "PROFISSIONAIS" Then
                    ...
                    SQL =  "INSERT into sbpi.Particular_Curso (sq_particular_curso, sq_cliente, sq_curso, pasta, parecer, portaria, observacao, idProfissional) " & VbCrLf & _ 
                ...
                ElseIf w_tipo = "OS" Then
                    ...
                    SQL =  "INSERT into sbpi.Particular_OS (sq_particular_os, sq_cliente, numero, data, dodf, dodf_pagina, dodf_data, observacao) " & VbCrLf & _ 
                ...
                ElseIf w_tipo = "PORTARIAS" Then
                    ...
                    SQL =  "INSERT into sbpi.Particular_Portaria (sq_particular_portaria, sq_cliente, numero, data, dodf, dodf_pagina, dodf_data, observacao) " & VbCrLf & _ 
    ...
    Case conWhatMensagem
       ...
       If w_ea = "I" Then
          ' Recupera o valor da próxima chave primária
          SQL = "select sbpi.sq_mensagem.nextval chave from sbpi.Mensagem_Aluno" & VbCrLf
          ConectaBD SQL
          w_chave = RS("chave")
          DesconectaBD
          
          ' Insere o arquivo
          SQL = " insert into sbpi.Mensagem_Aluno " & VbCrLf & _
                "    (sq_mensagem, sq_aluno, dt_mensagem, ds_mensagem, in_lida) " & VbCrLf & _
                " values ( " & w_chave & ", " & VbCrLf & _
                "     " & Request("w_sq_Aluno") & ", " & VbCrLf & _
                "     to_date('" & FormataDataEdicao(FormatDateTime(Request("w_dt_mensagem"),2)) & "','dd/mm/yyyy'), " & VbCrLf & _
          ...
          End If
       ElseIf w_ea = "A" Then
          SQL = " update sbpi.Mensagem_Aluno set " & VbCrLf & _
                "     dt_mensagem  = to_date('" & FormataDataEdicao(FormatDateTime(Request("w_dt_mensagem"),2)) & "','dd/mm/yyyy'), " & VbCrLf & _
          ...
          End If
       ElseIf w_ea = "E" Then
          SQL = " delete sbpi.Mensagem_Aluno where sq_mensagem = " & Request("w_chave") & VbCrLf
          ExecutaSQL(SQL)
    ...
    Case conWhatEspecialidade
       ...
       If w_ea = "I" Then
          ' Recupera o valor da próxima chave primária
          SQL = "select sbpi.sq_especialidade.nextval chave from sbpi.Especialidade" & VbCrLf
          ConectaBD SQL
          w_chave = RS("chave")
          DesconectaBD
          
          ' Insere o arquivo
          SQL = " insert into sbpi.Especialidade " & VbCrLf & _
          ...
          End If
       ElseIf w_ea = "A" Then
          SQL = " update sbpi.Especialidade set " & VbCrLf & _
          ...
          End If
       ElseIf w_ea = "E" Then
          SQL = " delete sbpi.Especialidade_Cliente where sq_especialidade = " & Request("w_chave") & VbCrLf
          ExecutaSQL(SQL)
          ...
          SQL = " delete sbpi.Especialidade where sq_especialidade = " & Request("w_chave") & VbCrLf
          ExecutaSQL(SQL)
    ...
    Case "CADASTROESCOLA"
       If Nvl(w_ea,"") = "I" Then
          SQL = "SELECT ds_username from sbpi.Cliente where ds_username = '" & Request("w_ds_username") & "'" & VbCrLf
          ConectaBD SQL
          ...
          End If
          DesconectaBD
          SQL = "SELECT sbpi.sq_cliente.nextval sq_cliente from sbpi.Cliente where sq_cliente < 99000 " & VbCrLf
          ConectaBD SQL
       ...
       If Nvl(w_ea,"") = "I" Then
          ...
          SQL = "insert into sbpi.Cliente (sq_cliente,              sq_cliente_pai,              sq_tipo_cliente,                            ds_cliente,  " & VbCrLf &_
                ...
                "                        '9"&w_chave & "','" & Request("w_ln_internet") & "','" & Nvl(Request("w_ds_email"),"Não informado") & "', sysdate,'" & Request("w_ativo") & "'); " & VbCrLf
          
          ExecutaSQL(SQL)
                
          'Criação das escolas na tabela que contém dados complementares'
          SQL = "insert into sbpi.Cliente_Dados (sq_cliente_dados,            sq_cliente,          nr_cnpj,                 tp_registro,  " & VbCrLf &_ 
          ...
          SQL = "insert into sbpi.Cliente_Site (sq_cliente,               sq_cliente,                   sq_modelo,                      no_contato_internet,              " & VbCrLf &_ 
          ...
          'Criação das escolas na tabela que contém modalidades de ensino oferecidas pela escola
          For i = 1 to Request("w_sq_especialidade").Count 
             SQL = "insert into sbpi.Especialidade_Cliente (sq_cliente, sq_especialidade ) values (" & w_chave & "," & Request("w_sq_especialidade") & ");" & VbCrLf
             ExecutaSQL(SQL)
          Next
       ElseIf Nvl(w_ea,"") = "A" Then
       
          'Altera os dados das escolas na tabela principal
          SQL = "update sbpi.Cliente set " & VbCrLf & VbCrLf &_
          ...
          ExecutaSQL(SQL)
          'Altera escolas na tabela que contém dados complementares
          SQL = "update sbpi.Cliente_Dados set " & VbCrLf & VbCrLf &_
          ...
          'Altera escolas na tabela que contém informações sobre o site web
          SQL = "update sbpi.Cliente_Site set " & VbCrLf & VbCrLf &_
          ...
          'Apaga escolas na tabela que contém modalidades de ensino oferecidas pela escola
          SQL = "delete sbpi.Especialidade_Cliente where sq_cliente = " & w_chave
          ExecutaSQL(SQL)
          
          'Criação das escolas na tabela que contém modalidades de ensino oferecidas pela escola
          For i = 1 to Request("w_sq_especialidade").Count 
             SQL = "insert into sbpi.Especialidade_Cliente (sq_cliente, sq_especialidade) values (" & w_chave & "," & Request("w_sq_especialidade")(i) & ");" & VbCrLf
             ExecutaSQL(SQL)
          Next
       End If
    ...
    Case "VERIFBANCO"
       ...
       For w_cont = 1 To Request.Form("arquivo").Count
        ...
        If strDir = "FOTO" Then
          SQL = "delete sbpi.Cliente_Foto WHERE SQ_CLIENTE_FOTO = " & strFile
        Else
          SQL = "delete sbpi.Cliente_Arquivo WHERE SQ_Arquivo = " & strFile
        End If        
        ExecutaSQL(SQL)
    ...
    Case "ESCPARTHOMOLOG"
       dbms.BeginTrans()
       For w_cont = 1 To Request.Form("w_chave").Count
          SQL = "update sbpi.Particular_Calendario SET homologado = '" & Request.Form("w_homologado")(w_cont) & "' , ultima_homologacao = sysdate WHERE sq_particular_calendario = " & Request.Form("w_chave")(w_cont)
          ExecutaSQL(SQL)       
       Next
       dbms.CommitTrans()
...
Public Sub ShowEscolas
  ...
  If p_tipo = "H" Then
     ...
     If Request("E") = "S" Then ShowHTML "          <input type=""radio"" name=""E"" value=""S"" CLASS=""BTM"" checked> Listar apenas escolas que informaram<br>"     Else ShowHTML "          <input type=""radio"" name=""E"" value=""S"" CLASS=""BTM""> Listar apenas escolas que informaram<br>"      End If
     If Request("E") = "N" Then ShowHTML "          <input type=""radio"" name=""E"" value=""N"" CLASS=""BTM"" checked> Listar apenas escolas que não informaram<br>" Else ShowHTML "          <input type=""radio"" name=""E"" value=""N"" CLASS=""BTM""> Listar apenas escolas que não informaram<br> " End If
  ...
  ElseIf Request("E") > "" Then
     ShowHTML "  <li><font size=""1""><b>"
     If Request("E") = "S" Then ShowHTML "          Listar apenas escolas que informaram dados administrativos</b>"      End If
     If Request("E") = "N" Then ShowHTML "          Listar apenas escolas que não informaram dados administrativos</b> " End If
  End If
  If p_tipo <> "W" Then
     ShowHTML "          </table>"
  End If
  ...
  If Request("pesquisa") > "" Then
     sql = "SELECT DISTINCT b.ds_username, d.sq_cliente, d.ds_cliente, d.ds_apelido, d.ln_internet, " & VbCrLf & _
           ...
           "       coalesce(h.existe,0) alunos, i.sq_cliente adm, d.ativo " & VbCrLf & _ 
           "  from sbpi.Cliente                                 d " & VbCrLf & _ 
           "       INNER      join sbpi.Cliente                 b ON (b.sq_cliente       = d.sq_cliente_pai) " & VbCrLf & _
           "       LEFT OUTER join sbpi.Cliente_Dados           e ON (d.sq_cliente       = e.sq_cliente) " & VbCrLf & _
           "       INNER      join sbpi.Cliente_Site            f ON (d.sq_cliente       = f.sq_cliente) " & VbCrLf & _
           "       INNER      join sbpi.Tipo_Cliente            g ON (d.sq_tipo_cliente  = g.sq_tipo_cliente) " & VbCrLf & _
           "       LEFT OUTER JOIN (select sq_cliente, count(*) existe " & VbCrLf & _
           "                          from sbpi.Aluno " & VbCrLf & _
           "                         group by sq_cliente " & VbCrLf & _
           "                       )                          h on (f.sq_cliente  = h.sq_cliente) " & VbCrLf & _
           "       LEFT OUTER join sbpi.Cliente_Admin           i on (d.sq_cliente       = i.sq_cliente) " & VbCrLf & _
           " where 1 = 1 " & VbCrLf
     If Mid(Session("username"),1,2) = "RE" Then
        SQL = SQL & "   and b.ds_username = '" & Session("USERNAME") & "' " & VbCrLf
     End If
     If Request("C") > "" Then SQL = SQL & "   and coalesce(h.existe,0) > 0 " & VbCrLf End If
     If Request("D") > "" Then SQL = SQL & "   and d.dt_alteracao     is not null " & VbCrLf End If
     If Request("E") > "" Then 
        If Request("E") = "S" Then 
...
'           "from sbpi.Especialidade a " & _ 
'           "     INNER join sbpi.Especialidade_cliente c ON (a.sq_especialidade = c.sq_especialidade) " & _
'           "     INNER join sbpi.Cliente d ON (c.sq_cliente = d.sq_cliente) " & _
...
'  End If
  ...
  If Request("pesquisa") > "" Then
     ...
     '      "--        INNER join sbpi.Calendario_cliente c ON (a.sq_cliente = c.sq_cliente) " & VbCrLf & _ 
     '      "        INNER join sbpi.Cliente_Particular d ON (a.sq_cliente = d.sq_cliente) " & VbCrLf & _ 
     ...
     sql = " SELECT DISTINCT a.sq_cliente, a.ds_cliente, a.ds_apelido, a.ln_internet, a.ds_username, a.ds_senha_acesso, a.no_municipio, a.sg_uf, a.dt_alteracao, d.diretor, d.secretario, d.telefone_1, d.fax, d.cep, d.endereco, d.email_1 " & VbCrLf & _ 
           ...
           if (Request("c") > "") Then 
              sql = sql & "      INNER join sbpi.Calendario_cliente c ON (a.sq_cliente = c.sq_cliente) " & VbCrLf & _ 
              "        INNER join sbpi.Cliente_Particular d ON (a.sq_cliente = d.sq_cliente) " & VbCrLf
           else
              sql = sql & VbCrLf & _ 
              "        INNER join sbpi.Cliente_Particular d ON (a.sq_cliente = d.sq_cliente) " & VbCrLf
           end if
...
Public Sub ShowEscolaParticularHomolog
  ...
  SQL = "SELECT sq_particular_calendario, sq_cliente cliente, nome, homologado from sbpi.Particular_Calendario WHERE sq_cliente = " & p_escola_particular
  ConectaBD SQL
...
Sub CadastroEscolas
  ...
  Dim w_ds_texto_abertura, w_sq_especialidade
  ...
  If InStr("A",w_ea) > 0 and w_Troca = "" Then
     ...
     SQL = " SELECT a.sq_cliente, sq_cliente_pai, sq_tipo_cliente, ds_cliente, ds_apelido, " & VbCrLf &_
           ...
           "   from sbpi.Cliente a " & VbCrLf &_
           "        LEFT OUTER join sbpi.Cliente_Dados b on (a.sq_cliente   = b.sq_cliente)  " & VbCrLf &_
           "        LEFT OUTER join sbpi.Cliente_Site  c on (a.sq_cliente   = c.sq_cliente)  " & VbCrLf &_
  ...
  ShowHTML "  var i; "
  ShowHTML "  var w_erro=true; "
  ShowHTML "  if (theForm.w_sq_especialidade.value==undefined) {"
  ShowHTML "     for (i=0; i < theForm.w_sq_especialidade.length; i++) {"
  ShowHTML "       if (theForm.w_sq_especialidade[i].checked) w_erro=false;"
  ShowHTML "     }"
  ShowHTML "  }"
  ShowHTML "  else {"
  ShowHTML "     if (theForm.w_sq_especialidade.checked) w_erro=false;"
  ShowHTML "  }"
  ShowHTML "  if (w_erro) {"
  ...
  SQL = "SELECT a.sq_modelo, a.ds_modelo from sbpi.Modelo a ORDER BY a.sq_modelo desc" & VbCrLf
  ConectaBD SQL  
  ...
  SQL = "SELECT a.*, c.sq_especialidade " & _ 
        "  from sbpi.Especialidade a " & _ 
        "       LEFT join sbpi.Especialidade_cliente c ON (a.sq_especialidade = c.sq_especialidade and " & _
        "                                     c.sq_cliente  = " & Nvl(w_chave,0) & ") " & _
        "       LEFT join sbpi.Cliente d ON (c.sq_cliente = d.sq_cliente  and " & _
  ...
  If Not RS.EOF Then
     ...
     Do While Not RS.EOF
        ...
        If Nvl(RS("sq_especialidade"),"") > "" Then
           ShowHTML chr(13) & "           <tr><td><input type=""checkbox"" name=""w_sq_especialidade"" value=""" & RS("sq_especialidade") & """ checked><td><font size=1>" & RS("ds_especialidade")
        Else
           ShowHTML chr(13) & "           <tr><td><input type=""checkbox"" name=""w_sq_especialidade"" value=""" & RS("sq_especialidade") & """><td><font size=1>" & RS("ds_especialidade")
        End If
        RS.MoveNext
  ...
  Set w_ds_institucional      = Nothing 
  Set w_ds_texto_abertura     = Nothing 
  Set w_sq_especialidade       = Nothing 
