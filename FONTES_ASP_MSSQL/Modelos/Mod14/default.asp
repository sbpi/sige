...
if(Request.QueryString("EW") = "116") Then
    ShowHTML "      <li><a class=""selected"" href=""" & w_dir & "Default.Asp?EW=116&EF=" & CL & "&CL=" & replace(CL,"sq_cliente=","") & "&IN=1"" >Proposta pedagógica</a></li>"
else
...
ShowHTML "	    </ul>"
ShowHTML "	    </div>"
ShowHTML "    <div id=""conteudo""><br/><!-- Conteúdo -->"
ShowHTML "      <h2><b>" & RS("ds_cliente") & "</b></h2>"
Select Case sstrEW
  Case conWhatPrincipal   ShowHTML "      <h3><b>Inicial</b></h3>"
'  Case conWhatManut       ShowHTML "      <h3><b>Alunos</b></h3>"
  Case conWhatQuem        ShowHTML "      <h3><b>Quem somos</b></h3>"
  Case conWhatExFale      ShowHTML "      <h3><b>Fale conosco</b></h3>"
  Case conWhatArquivo     ShowHTML "      <h3><b>Arquivos</b></h3>"
  Case conWhatExNoticia   ShowHTML "      <h3><b>Notícias</b></h3>"
...
Public Sub ShowQuem
  ...
  If Not RS.EOF Then
    ...
    If RS("sq_cliente_foto") > "" Then
       ...
       ShowHTML "  <ul>"
       Do While Not RS.EOF
          ShowHTML "   <li><a href=""" & RS("ds_diretorio") & "/" & RS("ln_foto") & """ target=""_blank""><img align=""top"" class=""foto"" src=""" & RS("ds_diretorio") & "/" & RS("ln_foto") & """ width=""50"" height=""50""> " & RS("ds_foto") & "</a></li>"
          RS.MoveNext
       Loop
       ShowHTML "  </ul>"
       ShowHTML "</table>"
