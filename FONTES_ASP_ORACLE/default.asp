...
'ShowHTML "      <div id=""busca"" valign=""center""><marquee width=""100%"" align=""middle""><font color=""white"" face=""Arial"" size=""2""><b>GDF - grandes transformações também no ensino público.</b></font></marquee></div> "
'ShowHTML "    </div>"
'ShowHTML "  </div>"
...
Public Sub ShowPesquisa
  ...
  if (Request("Z") > "") or (Request("Q") > "") or (Request("p_regional") > "") or (wIN > 0) then
   ...
   ' Response.Write(sql)
    ...
    Else
       ShowHTML "            <TR><TD colspan=2><p align=""justify""><img src=""img/ico_educacao.gif"" width=""16"" height=""16"" border=""0"" align=""center"">&nbsp;<b>Nenhuma ocorrência encontrada para opções acima."
    End If
    ShowHTML "          </table>"
  End If
