	...
	function menu() {
		...
		$i++;
		eval ('$node' . $i . ' = &$root->addItem(new XNode(\'Alteração de Senha\',$w_pagina.\'senha\',$w_Imagem,$w_Imagem,\'content\', null));');
		//$i++; eval('$node'.$i.' = &$root->addItem(new XNode(\'Dados adicionais\',$w_pagina.\'adicionais\',$w_Imagem,$w_Imagem,\'content\', null));');

		$i++;
		eval ('$node' . $i . ' = &$root->addItem(new XNode(\'Datas de Calendário \',$w_pagina.\'dtcalendario\',$w_Imagem,$w_Imagem,\'content\', null));');
		$i++;
		eval ('$node' . $i . ' = &$root->addItem(new XNode(\'Formulários de Calendário \',$w_pagina.\'formcal\',$w_Imagem,$w_Imagem,\'content\', null));');
		...
		eval ('$node' . $i . ' = &$root->addItem(new XNode(\'Calendário\',$w_pagina.\'calendario\',$w_Imagem,$w_Imagem,\'content\', null));');
		$i++;
		eval ('$node' . $i . ' = &$root->addItem(new XNode(\'Sair do sistema\',$w_pagina.\'Sair\',$w_Imagem,$w_Imagem,\'_top\', \'onClick="return(confirm(\\\'Confirma saída do sistema?\\\'));"\' ));');
