  ...
  function oferta() {
    ...
    If (Count($RS) > 0) {
      ...
      switch (intval(f($RS, "INFANTIL"))) {
        ...
        Case 0 :
          $modalidadeinf = "Não oferece";
          break;
        Case 1 :
          $modalidadeinf = "Creche";
          break;
        Case 2 :
          $modalidadeinf = "Pré-Escola";
          break;
        Case 4 :
          $modalidadeinf = "Creche e Pré-Escola";
          break;
      }
      switch (intval(f($RS, "FUNDAMENTAL"))) {
        Case 0 :
          $modalidadefund = "Não oferece";
          break;
        Case 1 :
          $modalidadefund = "1º ao 9º ano";
          break;
        Case 2 :
          $modalidadefund = "1º ao 9º ano e 1ª a 4ª	";
          break;
        Case 3 :
          $modalidadefund = "1º ao 9º ano e 1ª a 8ª";
          break;
        Case 4 :
          $modalidadefund = "1º ao 5º ano e 1ª a 4ª";
          break;
        Case 5 :
          $modalidadefund = "1º ao 5º ano e 1ª a 8ª";
          break;
        Case 6 :
          $modalidadefund = "1º ao 5º ano";
          break;
        Case 7 :
          $modalidadefund = "3ª e 4ª c/ext. prog. e 1º ao 9º ano";
          break;
        Case 8 :
          $modalidadefund = "3ª e 4ª c/ext. prog. e 1º ao 5º ano";
          break;
        Case 9 :
          $modalidadefund = "1ª a 4ª Séries";
          break;
        Case 10 :
          $modalidadefund = "1ª a 8ª Séries";
          break;
        Case 11 :
          $modalidadefund = "5ª a 8ª Séries";
          break;
      }

      switch (intval(f($RS, "MEDIO"))) {
        Case 0 :
          $modalidademed = "Não oferece";
          break;
        Case 1 :
          $modalidademed = "Oferece";
          break;
      }

      switch (intval(f($RS, "EJA"))) {
        Case 0 :
          $modalidadeeja = "Não oferece";
          break;
        Case 1 :
          $modalidadeeja = "1º e 2º Segmento";
          break;
        Case 2 :
          $modalidadeeja = "1º e 3º Segmento";
          break;
        Case 3 :
          $modalidadeeja = "2º e 3º Segmento";
          break;
        Case 4 :
          $modalidadeeja = "1º,2º e 3º Segmento";
          break;
        Case 5 :
          $modalidadeeja = "2º Segmento";
          break;
        Case 6 :
          $modalidadeeja = "3º Segmento";
          break;
        Case 7 :
          $modalidadeeja = "1º Segmento";
          break;
      }

      switch (intval(f($RS, "DISTANCIA"))) {
        Case 0 :
          $modalidadedist = "Não oferece";
          break;
        Case 1 :
          $modalidadedist = "Oferece";
          break;
      }
      switch (intval(f($RS, "PROFISSIONAL"))) {
        Case 0 :
          $modalidadeprof = "Não oferece";
          break;
        Case 1 :
          $modalidadeprof = "Oferece";
          break;
      }
