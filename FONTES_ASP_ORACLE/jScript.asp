...
Sub VerfHora
    ...
    Response.Write "      alert('O formato da hora é HH:MM.');" & VbCrLf
    Response.Write "      return (false);" & VbCrLf
    Response.Write "   }" & VbCrLf
    Response.Write "   if (nHora<0 || nHora>23){" & VbCrLf
    Response.Write "       alert('Hora inválida !');" & VbCrLf
    Response.Write "       return (false);" & VbCrLf
    Response.Write "   }" & VbCrLf
...
Sub CompData (Date1, DisplayName1, Operator, Date2, DisplayName2)
  ...
  Response.Write "      d1 = D1.substring(0,2); " & VbCrLf
  Response.Write "      m1 = D1.substring(3,2); " & VbCrLf
  Response.Write "      a1 = D1.substring(6,4); " & VbCrLf
  Response.Write "      h1 = D1.substring(12,2) + D1.substring(15,2); " & VbCrLf
  Response.Write "      d2 = D2.substring(0,2); " & VbCrLf
  Response.Write "      m2 = D2.substring(3,2); " & VbCrLf
  Response.Write "      a2 = D2.substring(6,4); " & VbCrLf
  Response.Write "      h2 = D2.substring(12,2) + D2.substring(15,2); " & VbCrLf
  ...
  Response.Write "      m1 = D1.substring(0,2); " & VbCrLf
  Response.Write "      a1 = D1.substring(3,6); " & VbCrLf
  Response.Write "      d2 = '01'; " & VbCrLf
  Response.Write "      m2 = D2.substring(0,2); " & VbCrLf
  Response.Write "      a2 = D2.substring(3,7); " & VbCrLf
  Response.Write "      Data1 = a1 + m1 + d1; " & VbCrLf
  Response.Write "      Data2 = a2 + m2 + d2; " & VbCrLf
  Response.Write "   } " & VbCrLf
...
Sub DecodeDate
  ...
  Response.Write "  day = date.substring(0, 2); " & VbCrLf
  Response.Write "  month = date.substring(3, 2); " & VbCrLf
  Response.Write "  year = date.substring(6, 4); " & VbCrLf
...
Sub FormataData
 ...
 'Response.Write "           if ( tam > 2 && tam < 5 ) campo.value = vr.substring( 0, 2 ) + '/' + vr.substring( 2, tam ); " & VbCrLf
 'Response.Write "           if ( tam >= 5 && tam <= 10 ) campo.value = vr.substring( 0, 2 ) + '/' + vr.substring( 2, 2 ) + '/' + vr.substring( 4, tam );  " & VbCrLf
 'Response.Write "      } " & VbCrLf
 'Response.Write "   } " & VbCrLf
 'Response.Write "} " & VbCrLf
End Sub
...
Sub FormataMat
 ...
 Response.Write "             campo.value = vr.substring( 0, tam - 1 ) + '-' + vr.substring( tam - 1, tam ) ; } " & VbCrLf
 Response.Write "    } " & VbCrLf
 Response.Write "} " & VbCrLf
End Sub
...
Sub CriticaNumero
 ...
 'Response.Write "     alert('O Campo não é válido !'); " & VbCrLf
 'Response.Write "     return false;" & VbCrLf
 'Response.Write "   }" & VbCrLf 
 Response.Write " }" & VbCrLf 
End Sub
...
Sub FormataValor
 ...
 ShowHTML "             campo.value = vr.substring( 0, tam - tammax ) + ',' + vr.substring( tam - tammax, tam ) ; }"
 ShowHTML "         if ( (tam >= (tammax+4)) && (tam <= (tammax + 6)) ){"
 ShowHTML "             campo.value = vr.substring( 0, tam - (tammax + 3) ) + '.' + vr.substring( tam - (tammax + 3), 3 ) + ',' + vr.substring( tam - tammax, tam ) ; }"
 ShowHTML "         if ( (tam >= (tammax + 7)) && (tam <= (tammax + 9)) ){"
 ShowHTML "             campo.value = vr.substring( 0, tam - (tammax + 6) ) + '.' + vr.substring( tam - (tammax + 6), 3 ) + '.' + vr.substring( tam - (tammax + 3), 3 ) + ',' + vr.substring( tam - tammax, tam ) ; }"
 ShowHTML "         if ( (tam >= (tammax + 10)) && (tam <= (tammax + 12)) ){"
 ShowHTML "             campo.value = vr.substring( 0, tam - (tammax + 9) ) + '.' + vr.substring( tam - (tammax + 9), 3 ) + '.' + vr.substring( tam - (tammax + 6), 3 ) + '.' + vr.substring( tam - (tammax + 3), 3 ) + ',' + vr.substring( tam - tammax, tam ) ; }"
 ShowHTML "         if ( (tam >= (tammax + 13)) && (tam <= (tammax + 15)) ){"
 ShowHTML "             campo.value = vr.substring( 0, tam - (tammax + 12) ) + '.' + vr.substring( tam - (tammax + 12), 3 ) + '.' + vr.substring( tam - (tammax + 9), 3 ) + '.' + vr.substring( tam - (tammax + 6), 3 ) + '.' + vr.substring( tam - (tammax + 3), 3 ) + ',' + vr.substring( tam - tammax, tam ) ;}"
 ShowHTML "      if ( campo.value.length + 1 > maximo ) { campo.value = ant_vr.substring(0, maximo -1); }"
 ShowHTML "    }"
 ShowHTML "}"
End Sub
...
Sub FormataCPF
 ...
 Response.Write "             campo.value = vr.substring( 0, tam - 2 ) + '-' + vr.substring( tam - 2, tam ) ; } " & VbCrLf
 Response.Write "         if ( (tam >= 6) && (tam <= 8) ){ " & VbCrLf
 Response.Write "             campo.value = vr.substring( 0, tam - 5 ) + '.' + vr.substring( tam - 5, 3 ) + '-' + vr.substring( tam - 2, tam ) ; } " & VbCrLf
 Response.Write "         if ( (tam >= 9) && (tam <= 11) ){ " & VbCrLf
 Response.Write "             campo.value = vr.substring( 0, tam - 8 ) + '.' + vr.substring( tam - 8, 3 ) + '.' + vr.substring( tam - 5, 3 ) + '-' + vr.substring( tam - 2, tam ) ; } " & VbCrLf
 Response.Write "    } " & VbCrLf
 Response.Write "} " & VbCrLf
End Sub
...
Sub FormataCNPJ
 ...
 Response.Write "             campo.value = vr ; } " & VbCrLf
 Response.Write "         if ( (tam > 2) && (tam <= 5) ){ " & VbCrLf
 Response.Write "             campo.value = vr.substring( 0, 2 ) + '.' + vr.substring( 2, tam ) ; } " & VbCrLf
 Response.Write "         if ( (tam >= 6) && (tam <= 8) ){ " & VbCrLf
 Response.Write "             campo.value = vr.substring( 0, 2 ) + '.' + vr.substring( 2, 3 ) + '.' + vr.substring( 5, tam ) ; } " & VbCrLf
 Response.Write "         if ( (tam >= 9) && (tam <= 12) ){ " & VbCrLf
 Response.Write "             campo.value = vr.substring( 0, 2 ) + '.' + vr.substring( 2, 3 ) + '.' + vr.substring( 5, 3 ) + '/' + vr.substring( 8, tam ) ; } " & VbCrLf
 Response.Write "         if ( (tam >= 13) && (tam <= 14) ){ " & VbCrLf
 Response.Write "             campo.value = vr.substring( 0, 2 ) + '.' + vr.substring( 2, 3 ) + '.' + vr.substring( 5, 3 ) + '/' + vr.substring( 8, 4 ) + '-' + vr.substring( 12, tam ) ; } " & VbCrLf
 Response.Write "    } " & VbCrLf
 Response.Write "} " & VbCrLf
End Sub
...
Sub FormataCEP
 ...
 Response.Write "         else { campo.value = vr.substring( 0, 5 )  + '-' + vr.substring( 5, tam ); } " & VbCrLf
 Response.Write "    } " & VbCrLf
 Response.Write "} " & VbCrLf
End Sub
...
Sub FormataDataHora
 ...
 Response.Write "            campo.value = vr.substring( 0, 2 ) + '/' + vr.substring( 2, 2 ) + '/' + vr.substring( 4, tam );  " & VbCrLf
 Response.Write "        if ( tam >=10 && tam <= 11 ) " & VbCrLf
 Response.Write "            campo.value = vr.substring( 0, 2 ) + '/' + vr.substring( 2, 2 ) + '/' + vr.substring( 4, 4 ) + ', ' + vr.substring( 8, tam );  " & VbCrLf
 Response.Write "        if ( tam >=12 ) " & VbCrLf
 Response.Write "            campo.value = vr.substring( 0, 2 ) + '/' + vr.substring( 2, 2 ) + '/' + vr.substring( 4, 4 ) + ', ' + vr.substring( 8, 2 ) + ':' + vr.substring( 10, tam );  " & VbCrLf
 Response.Write "    } " & VbCrLf
 Response.Write "  } " & VbCrLf
 Response.Write "} " & VbCrLf
End Sub
...
Sub FormataDataMA
 ...
 Response.Write "    if ( tecla == 8 || tecla >= 48 && tecla <= 57 || tecla >= 96 && tecla <= 105 ){ " & VbCrLf
 Response.Write "        if ( tam <= 2 ) campo.value = vr ;  " & VbCrLf
 Response.Write "        if ( tam > 2 ) campo.value = vr.substring( 0, 2 ) + '/' + vr.substring( 2, tam ); " & VbCrLf
 Response.Write "    } " & VbCrLf
 Response.Write "} " & VbCrLf
End Sub
...
Sub Validate(VariableName, DisplayName, DataType, ValueRequired, MinimumLength, MaximumLength, AllowLetters, AllowDigits)
  ...
  If ValueRequired > "" Then
     If uCase(DataType) = "SELECT" Then
        Response.Write "  if (theForm." & VariableName & ".selectedIndex == 0)" & VbCrLf
     Else
     ...
     Response.Write "    theForm." & VariableName & ".focus();" & VbCrLf
     Response.Write "    return (false);" & VbCrLf
     Response.Write "  }" & VbCrLf
     Response.Write VbCrLf
  End If
  IF MinimumLength > "" Then
     ...
     Response.Write "  {" & VbCrLf
     Response.Write "    alert('Favor digitar pelo menos " & MinimumLength & " posições no campo " & DisplayName & "');" & VbCrLf
     Response.Write "    theForm." & VariableName & ".focus();" & VbCrLf
     Response.Write "    return (false);" & VbCrLf
     Response.Write "  }" & VbCrLf
     Response.Write VbCrLf
  ...
  If MaximumLength > "" Then
     ...
     Response.Write "  {" & VbCrLf
     Response.Write "    alert('Favor digitar no máximo " & MaximumLength & " posições no campo " & DisplayName & "');" & VbCrLf
     Response.Write "    theForm." & VariableName & ".focus();" & VbCrLf
     Response.Write "    return (false);" & VbCrLf
     Response.Write "  }" & VbCrLf
     Response.Write VbCrLf
  ...
  If AllowLetters > "" or AllowDigits > "" Then
     ...
     Response.Write "       } " & VbCrLf
     Response.Write "       if (allValid == false) break;" & VbCrLf
     Response.Write "    } " & VbCrLf
     Response.Write "  }" & VbCrLf        
  ...
  If uCase(DataType) = "CGC" or uCase(DataType) = "CNPJ" Then
     ...
     "       alert('" & DisplayName & " inválido.');" & VbCrLf & _
  ...
  ElseIf uCase(DataType) = "CPF" Then
     ...
     "    D2 = modulo(soma,11)" & VbCrLf & _
     "    if (D2 > 9) { D2 = 0}" & VbCrLf & _
     "    if ((D1 == checkStr.charAt(10-1)) && (D2 == checkStr.charAt(11-1))) { allValid = true}" & VbCrLf & _
     "    else { allValid = false }" & VbCrLf & _
