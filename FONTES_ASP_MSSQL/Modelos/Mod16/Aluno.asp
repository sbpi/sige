...
'  ShowHTML "    <TD>Recup."
  ...
  If Not RS.EOF Then
   ...
   '	ShowHTML "    <TD>" & trocaNulo(RS("b4_recup"))
    ...
    If trocaNulo(RS("ds_recup_final")) > trocaNulo(RS("ds_media_final")) Then
...
'  ShowHTML "    <TD rowspan=2><FONT FACE=VERDANA SIZE=1>Recup. Esp."
  ShowHTML "    <TD rowspan=2><FONT FACE=VERDANA SIZE=1>Total Faltas"
  ...
  ShowHTML "    <TD><FONT FACE=VERDANA SIZE=1>Nota"
'  ShowHTML "    <TD><FONT FACE=VERDANA SIZE=1>Recup."
  ShowHTML "    <TD><FONT FACE=VERDANA SIZE=1>Falta"
  ShowHTML "    <TD><FONT FACE=VERDANA SIZE=1>Nota"
'  ShowHTML "    <TD><FONT FACE=VERDANA SIZE=1>Recup."
  ShowHTML "    <TD><FONT FACE=VERDANA SIZE=1>Falta"
  ShowHTML "    <TD><FONT FACE=VERDANA SIZE=1>Nota"
...
'  ShowHTML "    <TD><FONT FACE=VERDANA SIZE=1>Recup."
  ...
  If Not RS.EOF Then
   ...
   '	ShowHTML "    <TD><FONT FACE=VERDANA SIZE=1>" & trocaNulo(RS("b4_recup"))
      ...
      If cint(RS("ds_recup_final")) > cint(RS("ds_recup_final")) Then
        ShowHTML "    <TD>" & trocaNulo(RS("ds_recup_final"))
        ShowHTML "    <TD>" & trocaNulo(RS("ds_falta_anual"))
        ShowHTML "    <TD>" & trocaNulo(RS("ds_recup_final"))     
      Else
     ...
     ' Wend
         ShowHTML"   <TR><TD colspan=""2""><FONT FACE=VERDANA SIZE=1><B>Legenda dos Resultados:</B> "
    ShowHTML" <dl> "
    ShowHTML" <dt>AP: Aprovado</dt> "
    ShowHTML" <dt>AP*: Aprovado por dependência</dt> "
    ShowHTML" <dt>AP**: Aprovado por conselho de classe</dt> "
    ShowHTML" <dt>AP***: Dispensa menção classificatória</dt> "	
    ShowHTML" <dt>RP: Reprovado</dt> "
    ShowHTML" <dt>RP*: Reprovado por falta</dt> "
    ShowHTML" <dt>RF: Recuperação Final</dt> "
    ShowHTML" <dt>CS: Cursando</dt> "	
    ShowHTML" <dt>RP**: Reprovado por ter ultrapassado o número máximo de Comp. Curriculares para RF falta</dt> "
    ShowHTML" <dt>RP***: Reprovado por abandono</dt> "
    ShowHTML" <dt>D: Avaliação Diferenciada</dt> "
    ShowHTML" </dl> "
    ShowHTML"     </TABLE> "
